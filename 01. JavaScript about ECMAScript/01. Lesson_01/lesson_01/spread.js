...
function findMax() {
    ...
    /* arguments - переменная доступная внутри каждой функции, которая содержит в себе все аргументы,
...
// ******************* Задание *****************
// Вывести максимум из первых трех значений, оставшиеся аргументы вывести в консоль без изменений
const firsThree = bothGroupsTime.slice(0, 3);
const maxOfFirstThree = Math.max(...firsThree);
console.log(bothGroupsTime);
console.log(maxOfFirstThree, bothGroupsTime.slice(3));